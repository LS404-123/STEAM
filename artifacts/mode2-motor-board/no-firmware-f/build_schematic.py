"""F 候選原理圖：免韌體；借用既有 E 版的 KiCad S-expression 繪圖方式。"""
...
note('模式二 F 候選方案｜免燒錄硬體邏輯',15,13,3)
...
put('S0','SPDT',73,47,{'1':'BATT+','2':'VCC','3':'DISCH'},'PCB SPDT 電源開關',prop=(65,33))
...
note('S0：1–2 開；2–3 關。需可切換馬達負載的直流開關，參考 ≥3A DC；型號／封裝待選。',15,83,1.1)
...
note('同名網絡標籤均相連；_N / NOT_ 表示反相信號。電路圖的直角不是 PCB 銅線；PCB 尚未重新佈線。',15,288,1.05)
...
(ROOT/(NAME+'.kicad_sch')).write_text(f'(kicad_sch(version 20250114)(generator "eeschema")(uuid {SID})(paper "A3")(title_block(title "免韌體模式二候選原理圖")(date "2026-09-09")(rev "F 候選；非打板檔"))(lib_symbols {embedded})'+''.join(items)+'(embedded_fonts no))',encoding='utf-8')
