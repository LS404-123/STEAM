...
note('同名網絡標籤均相連；_N / NOT_ 表示反相信號。搭配 F 版 PCB；電路圖直角不代表銅線轉角。',15,288,1.05)
...
(ROOT/(NAME+'.kicad_sch')).write_text(f'(kicad_sch(version 20250114)(generator "eeschema")(uuid {SID})(paper "A3")(title_block(title "免韌體模式二原理圖")(date "2026-09-09")(rev "F 原型"))(lib_symbols {embedded})'+''.join(items)+'(embedded_fonts no))',encoding='utf-8')
